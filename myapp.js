...
const serverlessStackItem = `
    <div class="project-stack-item"> 
        <img class="serverless logo" src="https://d2j3yisnywcb30.cloudfront.net/pix/serverless-logo.png">
        <p class='name text'>Serverless</p>
    </div>
`;
...
const projectArr = [
  ...
  },
  {
    ...
    projectStack: `${mongoStackItem}${serverlessStackItem}${reduxStackItem}${reactStackItem}${nodeStackItem}`,
	...
	<section class="contact  animated" id="contact">
		<div class="contact-form"> 
			...
			<form style="text-align:center;" class="form-style-4" action="https://formspree.io/blackb8r@gmail.com"
				...
				<input style="text-align:center;" type="text" name="name" id="contact-form-name" placeholder="Your Name" required>
