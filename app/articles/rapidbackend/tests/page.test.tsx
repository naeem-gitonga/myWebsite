...
jest.mock('@/components/Articles/RapidBackEnd/RapidBackend', () => ({
  __esModule: true,
  default: () => <div data-testid="rapidbackend" />,
}));
...
describe('rapidbackend page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('rapidbackend')).toBeInTheDocument();
  });
  ...
  it('generates metadata', () => {
    ...
    expect(metadata.title).toBe('Exploring Functions as Microservices');
  });
});
