...
jest.mock('@/components/Articles/RegulatedCompute/RegulatedCompute', () => ({
  __esModule: true,
  default: () => <div data-testid="regulated-compute" />,
}));
...
describe('regulated-compute page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('regulated-compute')).toBeInTheDocument();
  });
  ...
  it('generates metadata', () => {
    ...
    expect(metadata.title).toBe('Regulated Compute: Chasing H100s for a Real-Time Avatar');
  });
});
