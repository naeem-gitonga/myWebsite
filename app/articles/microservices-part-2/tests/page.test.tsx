...
jest.mock('@/components/Articles/MicroPartTwo/MicroPartTwo', () => ({
  __esModule: true,
  default: () => <div data-testid="micro-part-2" />,
}));
...
describe('microservices-part-2 page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('micro-part-2')).toBeInTheDocument();
  });
  ...
  it('generates metadata', () => {
    ...
    expect(metadata.title).toBe('Micro Services Part II: AWS EC2 Linux AMIs');
  });
});
