...
jest.mock('@/components/LinkedInLockup/LinkedInLockup', () => ({
  __esModule: true,
  default: () => <div data-testid="linkedin-lockup" />,
}));
...
describe('linkedin-lockup page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('linkedin-lockup')).toBeInTheDocument();
  });
  ...
  it('generates metadata', () => {
    ...
    expect(metadata.title).toBe('LinkedIn Lockup: The Lead Vetter Story');
  });
});
