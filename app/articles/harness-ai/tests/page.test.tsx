...
jest.mock('@/components/Articles/HarnessAi/HarnessAi', () => ({
  __esModule: true,
  default: () => <div data-testid="harness-ai" />,
}));
...
describe('harness-ai page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('harness-ai')).toBeInTheDocument();
  });
