...
jest.mock('@/components/Articles/DefaultParameters/DefaultParameters', () => ({
  __esModule: true,
  default: () => <div data-testid="default-parameters" />,
}));
...
describe('default-parameters page', () => {
  it('renders article and analytics', async () => {
    ...
    expect(screen.getByTestId('default-parameters')).toBeInTheDocument();
  });
  ...
  it('generates metadata', () => {
    ...
    expect(metadata.title).toBe("Are JavaScript's default parameters slowing me down?");
  });
});
