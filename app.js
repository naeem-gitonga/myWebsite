...
const expressStackItem = 
	`<div class="project-stack-item"> 
		<img class="express logo" src="./pix/expressjslogo.png">
		<p class='name text'>Express.js</p>
	</div>`

const mongoStackItem =
	`<div class="project-stack-item"> 
		<img class="mongo logo" src="./pix/Mongo2.png" alt='MongoDB Logo'>
...
const standardPic = `
                <img id='standard' class='headshot animated flip' src='./pix/standardPic.jpeg'>
`;
			...
			<div class='image-container'>
				...
				<div class='overlay'>
					...
					<div class="project-links">
						<ul>
							<li class='project-link project-link-live'>
								<a class='pro-link text' href=${project.projectLink}>Live demo</a>
							</li>
							<li class='project-link project-link-github'>
								<a class='pro-link text'  href=${project.gitHubLink}>Source code</a>
							</li>
						</ul>
					</div>
				</div>
