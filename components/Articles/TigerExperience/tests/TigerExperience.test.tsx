...
import TigerExperience from '../TigerExperience';
...
describe('TigerExperience', () => {
  it('renders article heading', () => {
    render(<TigerExperience />);
    expect(screen.getByText('My TI:GER Experience')).toBeInTheDocument();
  });
});
