    ...
    <div id="cka" className={`${tenPadding}`}>
      ...
      <div className={`${width75} ${innerWrapper}`}>
        ...
        <p className={text}>
          ...
          &ldquo;SME&rdquo;, or authority on K8S? I am good at K8S as a result of
        ...
        <p className={text}>
          ...
          have not noticed anything &ldquo;in&rdquo; the job market, at work, I am
          ...
          importantly &ldquo;do we truly need…&rdquo; types of questions. Without
