...
import SamLambdaMongoDB from '../SamLambdaMongoDB';
...
describe('SamLambdaMongoDB', () => {
  it('renders article heading', () => {
    render(<SamLambdaMongoDB />);
    expect(
      screen.getByText('Deploy GoLambda With MongoDB and AWS SAM (Part 3)')
    ).toBeInTheDocument();
  });
});
