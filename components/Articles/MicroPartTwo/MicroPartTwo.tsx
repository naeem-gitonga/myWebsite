...
const nodeTestPem = '/images/node-test.gif';
const connecting = '/images/connect-instructions.gif';
const ubuntuTerminal = '/images/ubuntu-terminal.gif';
const itWorks = '/images/ec2-it-works.gif';
