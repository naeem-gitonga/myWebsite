    ...
    <div id="articles" className={viewWrapper}>
      ...
      <ArticleTile
        article={{
          ...
          articleUrl:
            'https://www.amazon.com/Program-Your-Life-Naeem-Gitonga/dp/1733442405/ref=sr_1_1?keywords=program+your+life+jaha+naeem+gitonga&qid=1580526523&sr=8-1&where=Amazon',
          isBook: true,
          type: 'My book',
        }}
      />
...
const articles = [
  {
    ...
    articleUrl: 'https://medium.com/p/bfc198770bb5?where=Medium',
  },
  {
    ...
    articleUrl:
      'https://naeemgtng.medium.com/dont-use-default-parameters-91cde9abde?where=Medium',
  },
  {
    ...
    articleUrl:
      'https://medium.com/p/javascripts-new-sexy-2843b0cf4a06?where=Medium',
  },
  {
    ...
    articleUrl:
      'https://medium.com/p/explain-servers-to-a-5-year-old-c59f8a4a2fac?where=Medium',
  },
  {
    ...
    articleUrl:
      'https://betterprogramming.pub/sam-deploys-golambda-w-mongodb-a03cd97bae45?source=friends_link&sk=21ab91d7cfdf2242928e9de61fab4f93&where=Medium',
  },
  {
    ...
    articleUrl:
      'https://medium.com/swlh/xml-read-send-write-javascript-front-to-node-back-167df21c98df?source=friends_link&sk=0a7a38647a21182748516408a15b24ba&where=Medium',
  },
  {
    ...
    articleUrl:
      'https://faun.pub/micro-services-part-ii-aws-ec2-linux-amis-4e5e644aa43a?source=friends_link&sk=0d641edad9f092218a1e5543c7cf1d82&where=Medium',
  },
  {
    ...
    articleUrl:
      'https://medium.com/p/micro-services-part-i-d9059d1a8ac0?where=Medium',
  },
  {
    ...
    articleUrl:
      'https://medium.com/swlh/react-context-api-and-lazy-loading-4c4b0a48f696?source=friends_link&sk=37e076874f86e49dc260d97b92025734&where=Medium',
  },
];
